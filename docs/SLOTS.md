...
Accessing `self.ui.<widget_name>` triggers lazy widget registration (see `MainWindow.__getattr__` in [mainWindow.py:218](../uitk/widgets/mainWindow.py#L218)) — safe to touch during `__init__`.
