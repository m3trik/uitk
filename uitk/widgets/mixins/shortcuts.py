    ...
    def show_editor(self, parent=None, title: str = "Shortcuts") -> None:
        ...
        if hasattr(self, "_editor") and self._editor is not None:
            try:
                ...
                pass
        self._editor = _ShortcutEditorDialog(
...
# ---------------------------------------------------------------------------
#  Shortcut editor dialogs (used by ShortcutManager.show_editor)
# ---------------------------------------------------------------------------
...
class _ShortcutEditorDialog(QtWidgets.QWidget):
    ...
    def _on_double_click(self, row, col):
        ...
        if row < len(entries) and entries[row][1].get("read_only"):
            return
        dlg = _KeyCaptureDialog(self._panel, current_key)
